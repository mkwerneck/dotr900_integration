...
public class VH73Device {
    ...
    /**
     * Os resultados analíticos obter o registro
     *
     * @param data
    ...
    public static HandsetParam parseReadDefaultParam(){
        HandsetParam param = new HandsetParam();
        ...
        param.USBBaudRate = 8;
        param.Reserve5 = 8;
        param.Min_Frequence = 10;
        param.Max_Frequence = 20;
        param.Power = 25;
        param.RFhrdVer1 = 1;
        param.RFhrdVer2 = 0;
        param.RFSoftVer1 = 1;
