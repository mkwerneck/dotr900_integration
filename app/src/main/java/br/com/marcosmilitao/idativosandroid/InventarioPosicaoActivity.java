...
public class InventarioPosicaoActivity extends BluetoothActivity implements OnBtEventListener {
    ...
    public void onBtConnected( BluetoothDevice device )
    {
        ...
        mainHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(InventarioPosicaoActivity.this, "Leitor conectado!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBtDisconnected(BluetoothDevice device)
    {
        ...
        mainHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(InventarioPosicaoActivity.this, "Leitor desconectado!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onBtConnectFail(BluetoothDevice device, String msg)
    {
        mainHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(InventarioPosicaoActivity.this, "Não foi possível conectar ao leitor. Tente novamente!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onBtDataTransException(BluetoothDevice device, String msg)
    {
        mainHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(InventarioPosicaoActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
